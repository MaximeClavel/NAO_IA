...
# initialise ID3
initID3([['angine-erythemateuse', 'elevee', 'gonflees', 'oui', 'oui', 'non', 'non', 'non', 'normale', 'normales',
          'normaux'],
         ['angine-pultacee', 'elevee', 'points-blancs', 'oui', 'oui', 'non', 'non', 'non', 'normale', 'normales',
          'normaux'],
         ['angine-diphterique', 'legere', 'enduit-blanc', 'oui', 'oui', 'non', 'non', 'non', 'normale', 'normales',
          'normaux'],
         ...
         ['rougeole', 'legere', 'normales', 'non', 'oui', 'non', 'oui', 'oui', 'normale', 'taches-rouges',
          'larmoyants'],
        ...
        [['maladies', 'angine-erythemateuse', 'angine-pultacee', 'angine-diphterique', 'appendicite', 'bronchite',
          'coqueluche',
